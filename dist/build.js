	...
	_createClass(Layout, [{
		...
		value: function render() {
			var _props = this.props,
			    ...
			    totalProducts = _props.totalProducts,
		...
		get: function get() {
			return this.props.products.map(function (item) {
				return _react2.default.createElement(
					'div',
					{ className: 'grid-cell', key: item.id },
					_react2.default.createElement(_cart2.default, { cart: item })
				);
			});
		}
	}]);
...
exports.default = (0, _reactRedux.connect)(function (_ref) {
	var products = _ref.products,
	    totalProducts = _ref.totalProducts,
	    totalPrice = _ref.totalPrice;

	return { products: products, totalProducts: totalProducts, totalPrice: totalPrice };
})(Layout);
...
module.exports = [{"id":"1","name":"Ball for Soccer","src":"https://dribling.com.ua/wa-data/public/shop/products/24/42/4224/images/5776/5776.970.jpg","description":"Great to play soccer","price":"2700.00","quantity":1,"limit":5},{"id":"2","name":"Ball for American Football","src":"https://dks.scene7.com/is/image/dkscdn/16WILUNFLGMBLLFFCFTB","description":"Great to play football","price":"1830.00","quantity":1,"limit":5},{"id":"3","name":"Gloves for Taekwon-Do","src":"http://fight-gear.su/images/p_perchatki-adidas-semi-contact-dlya-kikboksinga-i-thekvondo-itf-mft-gtf_1502955868_1.jpg","description":"Great to Taekwon-Do","price":"1500.00","quantity":1,"limit":5},{"id":"4","name":"Folding In Line Scooter","src":"https://media.very.co.uk/i/very/KYTWQ_SQ1_0000000099_N_A_SLf?$550x733_standard$","description":"Batman Folding In Line Scooter","price":"1730.00","quantity":1,"limit":5},{"id":"5","name":"Ball","src":"https://media.very.co.uk/i/very/MF3Q3_SQ1_0000000013_WHITE_SLf?$550x733_standard$&$roundel_very$&p1_img=sale_2017","description":"Nike England Prestige Football","price":"1830.00","quantity":1,"limit":5},{"id":"6","name":"Shimano Baitrunner ST 10000 RB","src":"https://media.very.co.uk/i/very/M9JT3_SQ1_0000000099_N_A_SLf?$550x733_standard$","description":"Shimano Baitrunner ST 10000 RB","price":"1900.00","quantity":1,"limit":5},{"id":"7","name":"iBobber Fish Finder","src":"https://media.very.co.uk/i/very/6N7AC_SQ1_0000000088_NO_COLOR_SLf?$550x733_standard$","description":"ReelSonar Fish Finder","price":"12440.00","quantity":1,"limit":5},{"id":"8","name":"Indigo Verso X Hybrid Bike","src":"https://media.very.co.uk/i/very/N49CJ_SQ1_0000000336_BLACK_RED_SLf?h=2199&w=1650","description":"Indigo Verso X Hybrid Bike 8 speed 650b 18 Inch Frame","price":"1890.00","quantity":1,"limit":5},{"id":"9","name":"Bicycle Light Set","src":"https://media.very.co.uk/i/very/LYVW7_SQ1_0000000088_NO_COLOR_SLf?$550x733_standard$","description":"AWEBright USB Rechargeable Bicycle Light Set 340 Lumens","price":"1600.00","quantity":1,"limit":5},{"id":"10","name":"RDX Leather Boxing Gloves","src":"https://media.very.co.uk/i/very/MUXMD_SQ1_0000013138_WHITE_GOLDEN_SLa?$550x733_standard$","description":"RDX Leather Boxing Gloves","price":"2150.00","quantity":1,"limit":5},{"id":"11","name":"RDX Pro","src":"https://media.very.co.uk/i/very/KH7RV_SQ1_0000000099_N_A_SLa?$550x733_standard$","description":"Pro Leather Skipping Jump Rope","price":"1830.00","quantity":1,"limit":5},{"id":"12","name":"RDX 3B Dino Kids Boxing Gloves","src":"https://media.very.co.uk/i/very/MUXH6_SQ1_0000000763_BLACK_GREEN_SLa?$550x733_standard$","description":"RDX 3B Dino Kids Boxing Gloves","price":"1840.00","quantity":1,"limit":5}]
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'image' },
          _react2.default.createElement('img', { src: cart.src }),
          _react2.default.createElement('div', { className: 'img-cover' })
        ),
        _react2.default.createElement(
          'div',
          { className: 'price' },
        ...
        _react2.default.createElement(_counter2.default, { value: amount, max: cart.limit, onDecrease: this.decrease, onIncrease: this.increase }),
        _react2.default.createElement(
          'div',
...
var Counter = function Counter(props) {
    ...
    return _react2.default.createElement(
        'div',
        { className: 'counter' },
        _react2.default.createElement('button', { className: 'decrease', onClick: onDecrease }),
        _react2.default.createElement(
            'div',
            { className: 'value' },
            value
        ),
        _react2.default.createElement('button', { className: 'increase', onClick: onIncrease })
    );
};
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(40), __webpack_require__(41)(module)))
